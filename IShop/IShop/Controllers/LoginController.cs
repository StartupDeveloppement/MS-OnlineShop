        ...
        public ActionResult Index(UtilisateurViewModel viewModel, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (utilisateur != null)
                {
                    ...
                    Session["CurrentUser"] = utilisateur;
                    UTILISATEUR userTest = (UTILISATEUR)Session["CurrentUSer"];
                    ...
                    switch (utilisateur.TYPE_UTILISATEUR.Trim())
                    {
                        case "Admin":
                            ...
                            break;
                        case "Vendeur":
                            return RedirectToAction("Index", "Vendeur", new { area = "Vendeur" });
                            break;
                        case "Client":
                            //return RedirectToAction("Index", "Home", new { area = "Client" });
                            ViewData["userName"] = userTest.EMAIL_UTILISATEUR; 
                            return View("Test");
                            break;
                        default:
                            return Redirect("/");
